...
public class BuilderBlock extends Block{
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ){
		//Forward this click to the tile entity.  For left-clicks we'll need to use item attack calls.
    ...
    public void addCollisionBoxToList(IBlockState state, World world, BlockPos pos, AxisAlignedBB entityBox, List<AxisAlignedBB> collidingBoxes, @Nullable Entity entity, boolean p_185477_7_){
    	...
    	AxisAlignedBB mcBox = block.getCollisionBox(WrapperWorld.getWrapperFor(world), new Point3d(pos.getX(), pos.getY(), pos.getZ())).convertWithOffset(0.5, 0.5, 0.5);
